...
**ContainerRunner** — Protocol (interface) for executing code in an isolated container. Implemented by `PodmanRunner`.
...
**DecisionRecord** — An Architectural Decision Record (ADR) documenting
