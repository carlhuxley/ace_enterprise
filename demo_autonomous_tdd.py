...
def main():
    ...
    # Demo 1: Simple feature (calculator)
    print("\n" + "─" * 80)
    print("DEMO 1: Simple Calculator")
    print("─" * 80)
    print("\nRequirement: 'Calculator that can add two numbers'")
    print("\nAgent will autonomously:")
    print("  1. Plan test increments (test_create, test_add, etc.)")
    ...
    try:
        result = agent.build_feature("Calculator that can add two numbers")
